...
export default function EstiramientoPiernasFlexionRodillas() {
  ...
  const passedNombre = location?.state?.nombre || 'Estiramiento de piernas y flexión de rodillas';
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">Estiramientos combinados y movimientos de flexión para movilizar la articulación de la rodilla con control.</p>
