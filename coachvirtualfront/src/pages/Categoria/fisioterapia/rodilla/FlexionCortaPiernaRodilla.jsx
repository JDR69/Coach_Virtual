...
export default function FlexionCortaPiernaRodilla() {
  ...
  const passedNombre = location?.state?.nombre || 'Flexión corta de pierna y rodilla';
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">Pequeñas flexiones de rodilla para mejorar rango articular y control muscular. Realiza movimiento controlado.</p>
