...
export default function CrunchInverso() {
  ...
  const handlePoseDetected = (landmarks) => {
    // Placeholder: implement counting logic using landmarks
  };
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">Acuéstate y acerca las piernas al pecho realizando el movimiento de crunch inverso.</p>
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">Crunch inverso concentrado en control lumbar y activación abdominal inferior.</p>
              <button onClick={() => setStarted(true)} className="w-full bg-blue-600 text-white py-3 rounded">Iniciar rutina</button>
            </div>
          </div>
        </div>
