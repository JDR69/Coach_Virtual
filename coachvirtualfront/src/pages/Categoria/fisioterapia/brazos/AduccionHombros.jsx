...
export default function AduccionHombros() {
  ...
  const handlePoseDetected = () => {
    // Placeholder: lógica de detección específica para fisioterapia vendrá después
  };
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">Ejercicio de rehabilitación para trabajar la aducción del hombro. Sigue las indicaciones en pantalla y mantén un ritmo controlado.</p>
